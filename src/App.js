    ...
    <div className="text-generator">
      ...
      <div className="menu-item">
        <label>Paragraph Numbers
          <input
            className="show-paragraph-numbers"
            type="checkbox"
            onChange={ e => setShowParagraphNumbers(e.target.checked)}
            value={showParagraphNumbers}/>
        </label>
      </div>
      <div className="menu-item">
        <label>Word Count
          <input
            className="show-word-count"
            type="checkbox"
      ...
      <div className="buttons">
        <button className="refresh-button" onClick={generateText}>Refresh Paragraphs</button>
